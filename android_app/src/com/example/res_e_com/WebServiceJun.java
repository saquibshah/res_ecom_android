...
//	private static String SOAP_ACTION = "http://example.prgguru.com/";
	...
	public static String invokeHelloWorldWS(String name, String webMethName, Context cxt) {
...
//			SoapObject soapMedicinesDTOList = (SoapObject) response.getProperty("restaurant");
...
//	            //mine
//	            Log.d("T","print "+i);
//	            item.id= Integer.parseInt(soapMedicinesDTO.getProperty(0).toString());
...
//            SoapObject response = (SoapObject)envelope.getResponse();
////            item.setId(id)=  Integer.parseInt(response.getProperty(0).toString());
